...
270 IF HT=9 OR HT=12 THEN HS=HS+3:CS=CS-3:PRINT">> YOU CRACK A STRAIGHT ROAD"
...
840 FOR I=1 TO 2000:NEXT I:RETURN
850 REM *** DICE ROLL
860 FOR Z=1 TO 3
