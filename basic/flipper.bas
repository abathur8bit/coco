...
40 REM RANDOMIZE VAL(RIGHT$(TIME$,2))
50 FOR C=1 TO 9
60  A(C)=Q
70  IF RND(100)>50 THEN A(C)=X
80 NEXT C
90 GOSUB 270
100 M=M+1
110 N=0
...
170 REM PRINT:PRINT "NUMBER OF X IS";N
180 REM PRINT:PRINT "YOU ONLY NEED ONE - IN THE":PRINT "MIDDLE SQUARE"
190 PRINT:PRINT "WHICH TO FLIP?"
...
285 IF P=0  THEN PRINT "NO FLIPS YET"
290 PRINT:PRINT "1 2 3";"   ";CHR$(A(1));" ";CHR$(A(2));" ";CHR$(A(3))
300 PRINT:PRINT "4 5 6";"   ";CHR$(A(4));" ";CHR$(A(5));" ";CHR$(A(6))
320 PRINT:PRINT "7 8 9";"   ";CHR$(A(7));" ";CHR$(A(8));" ";CHR$(A(9))
340 RETURN 
350 PRINT:PRINT
360 PRINT "YOU SOLVED IT IN ";M;"MOVES"
370 END
380 IF A(N)=X THEN RETURN
